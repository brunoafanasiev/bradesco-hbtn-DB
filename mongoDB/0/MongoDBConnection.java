...
public class MongoDBConnection {
    ...
    private static final String USERNAME = "brunoafanasiev_db_user";
    private static final String PASSWORD = "Av48mRGehi5aAHnG";
    private static final String CLUSTER_URL = "cluster0.pbz7xdf.mongodb.net"; // Substitua pelo seu cluster se for diferente
